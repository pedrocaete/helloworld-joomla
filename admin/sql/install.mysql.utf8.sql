...
INSERT INTO `#__helloworld` (`greeting`,`alias`,`language`, `parent_id`, `level`, `path`, `lft`, `rgt`, `published`, `access`) VALUES
('helloworld root','helloworld-root-alias','*', 0, 0, '', 0, 5, 1, 1),
('Hello World!','hello-world','en-GB', 1, 1, 'hello-world', 1, 2, 0, 1),
('Goodbye World!','goodbye-world','en-GB', 1, 1, 'goodbye-world', 3, 4, 0, 1);
